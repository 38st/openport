...
/// Rejects filters that cannot be honored by an upstream feed or recorded session.
...
/// or a missing API key/recording option. Replay opens and validates its header here.
